    ...
    if($numrows > 0){
        require("FPDF-master/fpdf.php");
            ...
            $pdf->AddPage('L','letter');
             // adding logo
            $logoFile = "logo3.png";
            $logoXPos = 120; //  position of logo in x coordinate
            ...
            $width_cell=array(20,70,60,20,45);
            ...
            $pdf->Cell($width_cell[4],10,'Contact Number',1,0,"C",true);
            $pdf->Cell($width_cell[4],10,'Birthdate',1,1,"C",true);
        while($row = mysqli_fetch_assoc($query)) {
            ...
            $pdf->Cell($width_cell[4],10,$row['contact_number'],1,0,"C",true);
             $pdf->Cell($width_cell[4],10,$row['birthdate'],1,1,"C",true);
             if(empty($id)){
                 $fileName = 'bodino.pdf';
            }else{
                 $fileName = $row['fullname'] . '.pdf';
            }
        }
